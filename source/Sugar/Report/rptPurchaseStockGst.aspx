<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPurchaseStockGst.aspx.cs" Inherits="Sugar_Report_rptPurchaseStockGst" %>
        ...
        <asp:Panel runat="server" ID="pnlMain" align="center" Font-Names="calibri" CssClass="largsize">
            ...
            <table width="90%" align="center" cellpadding="1" cellspacing="0" style="table-layout: fixed;
                ...
                <tr>
                    ...
                    <td align="right" style="width: 1%;">
                        <asp:Label ID="Label1" runat="server" Text="IGST" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="right" style="width: 1%;">
                        <asp:Label ID="Label2" runat="server" Text="CGST" Font-Bold="true"></asp:Label>
                    </td>
                    <td align="right" style="width: 1%;">
                        <asp:Label ID="Label12" runat="server" Text="SGST" Font-Bold="true"></asp:Label>
                    </td>
<%--                    <td align="right" style="width: 1%;">
                                                            ...
                                                            <ItemTemplate>
                                                                <table align="center" width="100%" cellpadding="1" cellspacing="2" style="table-layout: fixed;"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="lblpartyname" runat="server" Text='<%#Eval("IGST_Amount") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="Label9" runat="server" Text='<%#Eval("CGST_Amount") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                        <td align="right" style="width: 1%;">
                                                                            <asp:Label ID="Label13" runat="server" Text='<%#Eval("SGST_Amount") %>' Font-Bold="false"></asp:Label>
                                                                        </td>
                                                                      <%--  <td align="right" style="width: 1%;">
                                        ...
                                        <td style="width: 100%;">
                                            <table width="100%" align="center" cellspacing="0" cellpadding="1" style="table-layout: fixed;"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="width: 1%;">
                                                        <asp:Label ID="lblIGST_Amount" runat="server" Text="" Font-Bold="true" Visible="false"></asp:Label>
                                                    </td>
                                                    <td align="right" style="width: 1%;">
                                                        <asp:Label ID="lblCGST_Amount" runat="server" Text="" Font-Bold="true" Visible="false"></asp:Label>
                                                    </td>
                                                    <td align="right" style="width: 1%;">
                                                        <asp:Label ID="lblSGST_Amount" runat="server" Text="" Font-Bold="true" Visible="false"> </asp:Label>
                                                    </td>
                                                    <td align="right" style="width: 1%;">
                    ...
                    <td style="width: 100%;">
                        <table align="center" width="100%" cellpadding="1" cellspacing="2" style="table-layout: fixed;
                            ...
                            <tr>
                                ...
                                <td align="right" style="width: 1%;">
                                    <asp:Label ID="lblgrandIGST_Amount" runat="server" Text="" Font-Bold="true"></asp:Label>
                                </td>

                                <td align="right" style="width: 1%;">
                                    <asp:Label ID="lblgrandCGST_Amount" runat="server" Text="" Font-Bold="true"></asp:Label>
                                </td>
                                <td align="right" style="width: 1%;">
                                    <asp:Label ID="lblgrandSGST_Amount" runat="server" Text="" Font-Bold="true"></asp:Label>
                                </td> 
                                <td align="right" style="width: 2%;">
