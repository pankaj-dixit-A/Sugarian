...
public partial class Sugar_pgeAddressforvoucher : System.Web.UI.Page
{
    ...
    string CompanyNameColor = string.Empty;
    string AddressColor = string.Empty;
    #endregion
                ...
                if (isAuthenticate == "1" || User_Type == "A")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            txtcompanyColor.Text = ds.Tables[0].Rows[0]["CompanyNameColor"].ToString();
                            txtAddressColor.Text = ds.Tables[0].Rows[0]["AddressColor"].ToString();
                        }
                    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            CompanyNameColor = txtcompanyColor.Text;
            AddressColor = txtAddressColor.Text;
            string retValue = string.Empty;
            string strRev = string.Empty;
            ...
            if (s == "0")
            {
                ...
                Head_Fields = Head_Fields + "CompanyNameColor,";
                Head_Values = Head_Values + "'" + CompanyNameColor + "',";
                Head_Fields = Head_Fields + "AddressColor";
                Head_Values = Head_Values + "'" + AddressColor + "'";
            ...
            else
            {
                ...
                if (s1 != string.Empty)
                {
                    ...
                    Head_Update = Head_Update + "'" + dbbackup + "',";
                    Head_Update = Head_Update + "CompanyNameColor=";
                    Head_Update = Head_Update + "'" + CompanyNameColor + "',";
                    Head_Update = Head_Update + "AddressColor=";
                    Head_Update = Head_Update + "'" + AddressColor + "'";
                    #endregion
                }
                flag = 2;
